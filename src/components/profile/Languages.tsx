...
const Languages = () => {
    const array: string[] = ["Italiano", "Inglese", "Spagnolo", "Francese", "Tedesco", "Cinese", "Giapponese", "Arabo", "Russo"];
    const level: string[] = [
    ...
    const [lang, setLang] = useState<{ lang: string; level: string }[]>([]);
